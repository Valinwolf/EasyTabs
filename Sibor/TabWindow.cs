...
namespace Sibor
{
    public partial class TabWindow : Form
    {
        ...
        public TabWindow()
        {
            ...
            WebBrowser = new ChromiumWebBrowser(Settings.Default.NewTabURL)
            {
                Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right,
                Location = new Point(0, 63),
                MinimumSize = new Size(20, 20),
                Name = "webBrowser",
                Size = new Size(Width+1, Height-bookmarksBar.Height-toolbarBackground.Height),
                TabIndex = 6,
        ...
        {
            ((PictureBox)sender).BackgroundImage = Resources.ButtonHoverBackground;
        }
        ...
        {
            WebBrowser.Load(Settings.Default.HomeURL);
        }
